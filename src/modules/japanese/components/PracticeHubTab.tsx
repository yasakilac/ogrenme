...
export const PracticeHubTab: React.FC<PracticeHubTabProps> = ({
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-20 sm:pb-12">
      ...
      <div className="bg-white border border-[#E8E4DC] rounded-[20px] p-1.5 shadow-2xs max-w-2xl mx-auto">
          ...
          {practiceModes.map((mode) => {
            ...
            return (
              <button
                ...
                className={`py-2.5 sm:py-3 px-2 sm:px-3 rounded-[16px] font-bold text-xs sm:text-sm transition-all flex items-center justify-center gap-1.5 sm:gap-2 active:scale-95 ${
                  isActive

      ...
      <div className="bg-white border-2 border-[#EBE7E0] rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[11px] font-bold uppercase tracking-wider text-blue-800 bg-blue-100/70 px-2 py-0.5 rounded-md font-mono">
                  2. Temel Konu
                </span>
                <span className="text-xs text-stone-500 font-mono">Deklanşör Süresi</span>
              </div>
          ...
          <div className="grid grid-cols-5 gap-2 sm:gap-3">
            {SHUTTER_STOPS.map((stop, idx) => {
              ...
              return (
                ...
                >
                  <Timer className={`w-5 h-5 ${isSelected ? 'text-white' : 'text-blue-600'}`} />
                  <span className="font-mono font-black text-xs sm:text-sm">{stop.s}</span>
                </button>
              );
            })}
          </div>
          ...
          <div className="relative rounded-2xl overflow-hidden border-2 border-stone-300 bg-stone-900 shadow-md">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-transparent to-black/40 flex flex-col justify-between p-4 sm:p-5 pointer-events-none">
              <div className="flex items-center justify-between">
                <span className="bg-black/75 backdrop-blur-md px-3 py-1 rounded-xl text-cyan-300 font-mono text-xs font-bold border border-cyan-500/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            ...
            className="p-4 rounded-2xl bg-[#FAF8F5] border border-[#EBE7E0] hover:bg-stone-100 transition-all flex items-center justify-between text-left group cursor-pointer"
          >

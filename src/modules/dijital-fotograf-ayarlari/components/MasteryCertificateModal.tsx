...
export const MasteryCertificateModal: React.FC<MasteryCertificateModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/80 backdrop-blur-md overflow-y-auto print:p-0 print:bg-white print:static">
      <div className="relative w-full max-w-4xl bg-white rounded-[24px] shadow-2xl border-4 border-[var(--accent)]/60 overflow-hidden my-auto print:border-none print:shadow-none print:rounded-none print:max-w-none">
        ...
        <div className="no-print bg-stone-900 text-stone-300 px-6 py-3.5 flex items-center justify-between border-b border-stone-800">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-[16px] bg-stone-800 hover:bg-stone-700 text-white text-xs font-bold transition-colors cursor-pointer"
              title="Başarıyı Kopyala"
            >
              {copied ? <Check className="w-3.5 h-3.5 text-[var(--accent)]" /> : <Share2 className="w-3.5 h-3.5" />}
              <span className="hidden sm:inline">{copied ? 'Kopyalandı!' : 'Paylaş'}</span>
            </button>

            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-[16px] bg-[var(--accent)] hover:bg-[var(--accent)] text-stone-950 text-xs font-bold transition-colors cursor-pointer shadow-xs"
            ...
            <button
              onClick={onClose}
              className="p-1.5 rounded-[16px] text-stone-400 hover:text-white hover:bg-stone-800 transition-colors cursor-pointer ml-1"
              aria-label="Kapat"
            >
              <X className="w-5 h-5" />
            </button>
        ...
        <div className="no-print bg-[var(--accent-light)]/70 border-b border-[var(--accent)]/80 px-6 py-2.5 flex flex-wrap items-center justify-between gap-3 text-xs">
          ...
          <div className="flex items-center gap-2 flex-1 max-w-xs">
            <input
              ...
              className="w-full px-3 py-1 text-xs bg-white border border-[var(--accent)] rounded-lg text-stone-800 font-bold focus:outline-hidden focus:ring-2 focus:ring-[var(--accent)]"
            />
          </div>
        </div>
        ...
        <div className="p-6 sm:p-12 bg-[#FFFDF9] text-stone-900 relative">
          ...
          <div className="relative border-4 border-double border-[var(--accent)]/40 rounded-[20px] p-6 sm:p-10 bg-gradient-to-b from-[#FFFDF9] via-[#FAF6EE] to-[#FFFDF9]">
            {/* Köşe Süsleri */}
            <div className="absolute top-2 left-2 w-6 h-6 border-t-2 border-l-2 border-[var(--accent)]/80" />
            <div className="absolute top-2 right-2 w-6 h-6 border-t-2 border-r-2 border-[var(--accent)]/80" />
            <div className="absolute bottom-2 left-2 w-6 h-6 border-b-2 border-l-2 border-[var(--accent)]/80" />
            <div className="absolute bottom-2 right-2 w-6 h-6 border-b-2 border-r-2 border-[var(--accent)]/80" />

            {/* Üst Başlık & Logo */}
            <div className="text-center space-y-2 mb-6">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-tr from-[var(--accent)] via-[var(--accent)] to-[var(--accent)] text-stone-950 shadow-md mb-1">
                <Camera className="w-8 h-8" />
              </div>

              <div className="tracking-[0.25em] text-xs uppercase font-extrabold text-[var(--accent)] ">
                FotoGrafi Eğitim Portalı & Optik Akademisi
              </div>

              <h1 className="text-2xl sm:text-4xl font-display font-black tracking-tight text-stone-900 uppercase">
                Fotoğrafçılık Ustalık Sertifikası
              </h1>

              <div className="text-xs sm:text-sm font-display italic text-stone-600">
            ...
            <div className="text-center space-y-4 my-6">
              ...
              <div className="py-2 border-b-2 border-[var(--accent)]/40 max-w-md mx-auto">
                <span className="text-2xl sm:text-4xl font-display font-bold text-[var(--accent)] block">
                  {studentName || 'Öğrenci'}
                </span>
              </div>
            ...
            <div className="my-6 p-4 rounded-[16px] bg-[var(--accent-light)]/40 border border-[var(--accent)]/60 max-w-2xl mx-auto">
              <div className="text-[11px] font-bold uppercase tracking-wider text-[var(--accent)] text-center mb-2.5">
            ...
            <div className="pt-6 border-t border-[var(--accent)]/80 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
              {/* Tarih ve Kod */}
              ...
              {/* Altın Mühür Rozeti */}
              <div className="w-20 h-20 rounded-full border-4 border-[var(--accent)] bg-gradient-to-br from-[var(--accent)] via-[var(--accent-light)] to-[var(--accent)] p-1 flex flex-col items-center justify-center text-stone-900 shadow-md text-center shrink-0">
                ...
                <span className="text-[7px] font-extrabold uppercase block text-[var(--accent)]">
                  Resmi Onay
                </span>
                <ShieldCheck className="w-3 h-3 text-[var(--accent)] mt-0.5" />
              </div>

              {/* Yetkili İmza Hattı */}
              <div className="space-y-1 text-center">
                <div className="font-display italic text-sm text-stone-800 font-bold tracking-wider">

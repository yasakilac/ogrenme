      ...
      <div className="bg-white border-2 border-[#EBE7E0] rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#F0ECE6] pb-5">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-purple-50 border border-purple-200 text-purple-700 flex items-center justify-center shrink-0">
              <Sparkles className="w-7 h-7" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[11px] font-bold uppercase tracking-wider text-purple-800 bg-purple-100/70 px-2 py-0.5 rounded-md font-mono">
                  3. Temel Konu
                </span>
                <span className="text-xs text-stone-500 font-mono">Sensör Duyarlılığı</span>
              </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-xs text-stone-600">
            ...
            <span className="font-mono font-bold text-purple-800 bg-purple-50 px-2.5 py-1 rounded-lg border border-purple-200">
          ...
          <div className="grid grid-cols-5 gap-2 sm:gap-3">
            {ISO_STOPS.map((stop, idx) => {
              ...
              return (
                ...
                >
                  <Sparkles className={`w-5 h-5 ${isSelected ? 'text-white' : 'text-purple-600'}`} />
                  <span className="font-mono font-black text-xs sm:text-sm">{stop.iso}</span>
                </button>
              );
            })}
          </div>
          ...
          <div className="relative rounded-2xl overflow-hidden border-2 border-stone-300 bg-stone-900 shadow-md">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-transparent to-black/40 flex flex-col justify-between p-4 sm:p-5 pointer-events-none">
              <div className="flex items-center justify-between">
                <span className="bg-black/75 backdrop-blur-md px-3 py-1 rounded-xl text-purple-300 font-mono text-xs font-bold border border-purple-500/30">

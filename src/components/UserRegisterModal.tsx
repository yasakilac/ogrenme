...
import { User, X, Plus, Check, ShieldCheck, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-sm">
      <motion.div
        ...
        className="bg-white border border-[#E6E1D8] rounded-3xl w-full max-w-md shadow-2xl overflow-hidden p-5 sm:p-6 space-y-5"
      >
        ...
        <div className="pt-2 border-t border-[#E6E1D8] flex items-center justify-between text-xs">
          <span className="text-[#7A756D]">İçerik ve ayarları yönet:</span>
          <button
            type="button"
            onClick={() => {
              onClose();
